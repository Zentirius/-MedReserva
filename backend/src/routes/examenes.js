...
router.get('/', async (req, res) => {
  try {
    ...
    if (!rows || rows.length === 0) {
      rows = [
        { id: 1, nombre: 'Examen A', precio_base: 0, viajes_requeridos: 1 },
        { id: 2, nombre: 'Examen B', precio_base: 0, viajes_requeridos: 2 },
        { id: 3, nombre: 'Examen C', precio_base: 0, viajes_requeridos: 4 }
      ];
    }
